//create a doubly linked list few records init
//give user the option to view them(display)
//option to delete the record with particular id (delete)
//and to add after a particular id(Insert)
#include<stdio.h>
#include<stdlib.h>
struct stu{
    struct stu * pre;
