...
3. Submit a pull request with your updates, corrections, or new exercises.  

Your contributions will be **acknowledged** in the repo.  

## 🙏 Credits

- **Balajee Seshadri:** For the inspiration, exercises, and guidance through his C course that helped form the backbone of this repository.  
- **Author:** Sri Lakshmanan — Compiled, structured, and enhanced the exercises to create a comprehensive learning path.  

## 🔄 Updates

This repository is a **living resource**, regularly updated with new exercises, explanations, and improvements.  

## 🚀 Getting Started

1. Clone the repository:  
```bash
git clone https://github.com/ramlaksh2501/learn-c.git
